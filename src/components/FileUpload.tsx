...
export const FileUpload: React.FC<FileUploadProps> = ({ onFileProcessed }) => {
    ...
    return (
        <div className="flex items-center">
            <label htmlFor="file-upload" className="relative cursor-pointer bg-transparent rounded-2xl font-black text-slate-600 hover:text-blue-400 focus-within:outline-none p-3 hover:bg-slate-800 transition-all border border-transparent hover:border-slate-700">
