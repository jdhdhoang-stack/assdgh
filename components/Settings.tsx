                    ...
                    <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 space-y-4">
                        ...
                        <ul className="text-sm text-slate-600 space-y-3 font-medium">
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    <span className="text-slate-900 font-bold">Dòng 1:</span> Engine TTS (Capcut Token hoặc Gemini API Key)
                                </div>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="h-1.5 w-1.5 rounded-full bg-blue-500 mt-2 shrink-0"></span>
                                <div>
                                    <span className="text-slate-900 font-bold">Lưu ý:</span> Nếu dùng giọng Gemini, hệ thống sẽ tự động dùng API Key mặc định nếu có.
                                </div>
                            </li>
                        </ul>
